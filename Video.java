...
public class Video implements Comparable<Video> {
	...
	public Video(String title, String url, int durationInMinutes, Genre videoGenre) {
		//Double check to see about ensuring durationInMinutes won't equal null
		if(title.isBlank()||url.isBlank()||title==null||url==null||videoGenre==null) {
	...
	public Genre getGenre() {
		//************Double check if she wants a String or the Genre enum****************
		return videoGenre;
	}
